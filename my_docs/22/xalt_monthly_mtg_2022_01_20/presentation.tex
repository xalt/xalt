...
\begin{frame}[fragile]
 ...
 {\small
    \begin{semiverbatim}
 python ./xalt_usage_report.py --confFn xalt_frontera_db.conf --syshost frontera --start '2021-12-20'
    \end{semiverbatim}
}
  \begin{itemize}
...
1,183,467,488    1,064      651  3,544,533  281,720  gcc
1,140,838,707      984      624  1,062,676  235,540  impi
  629,361,768      581      377    670,258  142,934  impi/19.0.9(gcc/9.1.0)
  579,969,929      194      151    234,444  31,519   phdf5
  556,355,447      643      392  1,484,379  176,090  gcc/8.3.0
  511,432,610      105       76    208,669  20,324   phdf5/1.10.4(intel/19.0.4:impi/19.0.4)
  475,379,381      253      132    298,122  66,894   impi/19.0.7(gcc/9.1.0)
  441,465,631      550      372  1,269,790  121,421  intel
